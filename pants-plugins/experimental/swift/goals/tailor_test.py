...
import pytest
from experimental.swift.goals import tailor
from experimental.swift.goals.tailor import PutativeSwiftTargetsRequest
from experimental.swift.target_types import SwiftSourcesGeneratorTarget
